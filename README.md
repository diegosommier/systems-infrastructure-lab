...
> A hands-on systems administration and infrastructure project covering Linux, Windows, virtualization, storage, networking, security, monitoring and automation.

## 📖 Overview

This project was developed as the final project of a **Systems Administration course at Dicampus**, combining the administration and configuration tasks covered throughout the course into a practical infrastructure environment.

The lab uses virtual machines and shared classroom infrastructure to build and configure a mixed **Linux and Windows environment**, bringing together storage, networking, security, services, backups, monitoring, inventory, automation and Active Directory integration.
...
The infrastructure combined Linux and Windows systems with shared services and centralized identity management.
...
* CentOS installation and initial configuration.
* Static network configuration.
...
Storage was designed with redundancy and logical volume management:
...
A complete web application stack was deployed using:
...
The Linux environment was integrated with:
...
The project also incorporated Windows-based infrastructure.
...
A Windows Server 2012 environment was used for centralized domain administration, including:
...
The complete original project report is available in the [`docs/`](docs/) directory.

**[📄 Read the complete project report](docs/)**
...
*Year: 2018 · Focus: Systems Administration · Infrastructure · Linux · Windows · Virtualization · Storage · Security · Monitoring · Automation*
